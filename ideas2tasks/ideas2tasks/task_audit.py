...
用法：
  python3 -m ideas2tasks.task_audit                    # 全域稽核
  python3 -m ideas2tasks.task_audit --project xxx      # 指定專案稽核
"""
...
def read_task_meta(fp: Path) -> dict:
...
def read_readme_tasks(readme_path: Path) -> dict:
...
def audit_project(project_dir: Path) -> tuple[list, list, list]:
